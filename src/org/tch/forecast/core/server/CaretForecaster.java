...
public class CaretForecaster {
  ...
  static {
    ...
    seriesOutHash.put(ImmunizationForecastDataBean.DIPHTHERIA, "101"); // D/T
                                                                       // Series
    seriesOutHash.put(ImmunizationForecastDataBean.TDAP, "101"); // D/T Series
    seriesOutHash.put(ImmunizationForecastDataBean.HEPA, "102"); // Hepatitis A
                                                                 // Series
    seriesOutHash.put(ImmunizationForecastDataBean.HEPB, "103"); // Hepatitis B
                                                                 // Series
    ...
    seriesOutHash.put(ImmunizationForecastDataBean.MEASLES, "105"); // MMR
                                                                    // Series
    seriesOutHash.put(ImmunizationForecastDataBean.MUMPS, "105"); // MMR Series
    seriesOutHash.put(ImmunizationForecastDataBean.RUBELLA, "105"); // MMR
                                                                    // Series
    seriesOutHash.put(ImmunizationForecastDataBean.POLIO, "106"); // IPV/OPV
                                                                  // Series
    seriesOutHash.put(ImmunizationForecastDataBean.VARICELLA, "107"); // Varicella
    // seriesOutHash.put("", "108"); // HBIG -- IMM/Serve treats HBIG as a
    // standalone series
    seriesOutHash.put(ImmunizationForecastDataBean.TD, "109"); // D/T Series
    seriesOutHash.put(ImmunizationForecastDataBean.ROTAVIRUS, "110"); // Rotavirus
                                                                      // Series
    seriesOutHash.put(ImmunizationForecastDataBean.PNEUMO, "111"); // Strep-Pneumococcal
                                                                   // Series
    seriesOutHash.put(ImmunizationForecastDataBean.INFLUENZA, "112"); // Influenza
                                                                      // Series
    seriesOutHash.put(ImmunizationForecastDataBean.MENING, "113"); // Meningococcal
                                                                   // Series
  ...
  static {
    ...
    doseDueOutHash.put(ImmunizationForecastDataBean.HEPB, "8"); // Hep B
                                                                // adolescent or
                                                                // pediatric
    doseDueOutHash.put(ImmunizationForecastDataBean.TD, "9"); // Td adult
    doseDueOutHash.put(ImmunizationForecastDataBean.POLIO, "10"); // IPV
    doseDueOutHash.put(ImmunizationForecastDataBean.HIB, "17"); // Hib
                                                                // unspecified
    ...
    doseDueOutHash.put(ImmunizationForecastDataBean.HEPA, "31"); // Hep A
                                                                 // pediatric
    doseDueOutHash.put(ImmunizationForecastDataBean.PNEUMO, "33"); // Strep
                                                                   // Pneumococcal
                                                                   // (polysacchoride)
    // doseDueOutHash.put(ImmunizationForecastDataBean. ,"49"); // Hib PRP-OMP
    doseDueOutHash.put(ImmunizationForecastDataBean.HPV, "62"); // HPV,
                                                                // quadrivalent
    // doseDueOutHash.put(ImmunizationForecastDataBean. ,"89"); // Unspecified
    // Polio
    doseDueOutHash.put(ImmunizationForecastDataBean.MENING, "114"); // Meningococcal
                                                                    // (MCV4)
    ...
    // pentavalent
    // doseDueOutHash.put(ImmunizationForecastDataBean. ,"119"); // Rotavirus,
    // monovalent
    doseDueOutHash.put(ImmunizationForecastDataBean.ROTAVIRUS, "122"); // Rotavirus,
                                                                       // NOS
    // doseDueOutHash.put(ImmunizationForecastDataBean. ,"128"); // H1N1-09, NOS
    doseDueOutHash.put(ImmunizationForecastDataBean.PNEUMO, "133"); // Pneumococcal,
                                                                    // PCV13
    doseDueOutHash.put(ImmunizationForecastDataBean.INFLUENZA, "141"); // Influenza,
                                                                       // seasonal,
                                                                       // injectable
    // doseDueOutHash.put(ImmunizationForecastDataBean. ,"-10"); // Td Adult
    // Booster
    // doseDueOutHash.put(ImmunizationForecastDataBean. ,"-12"); // Unspecified
    // D/T
  ...
  public String forecast(VaccineForecastManager vaccineForecastManager, Map<String, Integer> cvxToVaccineIdMap) throws Exception {
