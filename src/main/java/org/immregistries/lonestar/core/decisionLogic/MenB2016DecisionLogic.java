...
public abstract class MenB2016DecisionLogic extends DecisionLogic {
  ...
  protected boolean fourMonthsHavePastSinceSecondDoseOfTrumena(DataStore ds,
  ...
  protected boolean sixMonthsHavePastSinceFirstDoseOfTrumena(DataStore ds,
      List<VaccinationDoseDataBean> validVaccinations) {
    boolean past = false;
  ...
  protected boolean isFirstDoseOfTrumenbaReceivedMoreThanEightWeeksAgo(DataStore ds,
      List<VaccinationDoseDataBean> validVaccinations) {
    boolean past = false;
