...
public class MenB2016MultiDoseStateDecisionLogic extends MenB2016DecisionLogic {
  ...
  public String getTransition(DataStore ds) {
    ...
    if (!fourMonthsHavePastSinceSecondDoseOfTrumena(ds, validVaccinations)) {
      ds.log(
          " + There are 2 Trumenba doses and less than 4 months have passed since the 2nd dose.");
      return "B2b";
    } else if (!sixMonthsHavePastSinceFirstDoseOfTrumena(ds, validVaccinations)) {
      ds.log(
          " + There are 2 Trumenba doses and less than 6 months have passed since the 1st dose.");
      return "B2b";
    } else {
      ds.log(
          " + There are 2 Trumenba doses and 4 months have passed since the 2nd dose and 6 months have passed since 1st dose.");
      return "M-final";
    }
  }
}
