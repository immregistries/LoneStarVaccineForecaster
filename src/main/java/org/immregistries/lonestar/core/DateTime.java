...
public class DateTime implements Serializable {
  ...
  private static String[] monthNamesLong = {"January", "February", "March", "April", "May", "June",
  ...
  private static String[] weekNamesShort = {"Sun", "Mon", "Tue", "Wed", "Thur", "Fri", "Sat"};
  private static String[] weekNamesVeryShort = {"Su", "M", "Tu", "W", "Th", "F", "Sa"};
  ...
  public int getDaysBetween(DateTime dt) {
    long difInSeconds =
        getCalendarDateOnly().getTimeInMillis() - dt.getCalendarDateOnly().getTimeInMillis();
    if (difInSeconds > 0) {
